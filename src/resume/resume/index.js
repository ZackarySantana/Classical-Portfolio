			...
			>
				<Column title="Education" description="(Miami, FL)">
					<ColumnItem
						item={
							<p>
								<abbr title="Florida International University">
									FIU
								</abbr>{" "}
					...
					<ColumnItem
						item={
							<p>
								<abbr title="TERRA Environmental Research Institute">
									TERRA
								</abbr>{" "}
								- High School
							</p>
				...
				<Column title="Skills">
					...
					/>
					<ColumnItem item="Version Control" subItems={["Git"]} />
					<ColumnItem
						item="Programming"
						subItems={["Java", "C++", "VisualBasic.net"]}
					/>
					<ColumnItem
						item="Familiar with"
						subItems={[
							<abbr title="Search Engine Optimization">SEO</abbr>,
							<abbr title="Single Responsibility, Open-Closed, Liskov subsitution, Interface, Dependency">
								SOLID
							</abbr>,
